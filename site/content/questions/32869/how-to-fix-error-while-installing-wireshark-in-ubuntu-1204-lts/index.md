...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-32869-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>As I try to install wireshark I get following error and unable to isntall OpenFlow extension? so unable to run OF filter in it.</p><pre><code> 8 files updated, 0 files merged, 0 files removed, 0 files unresolved
