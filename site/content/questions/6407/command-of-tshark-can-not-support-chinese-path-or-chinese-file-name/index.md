...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-6407-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>tshark` fails if its parameters contain Chinese characters (in a path parameter). For example:</p><pre><code>tshark -r d:\中文.pcap -V -T text &gt; d:\1.txt</code></pre><p>wireshark 1.5.1 has solved the problem. but how to correct the source code if i just want to use wireshark1.2.9 ? which code of wireshark1.2.9 should be modified in order to solve the problem.</p><p>Thanks.</p></div><div id="question-tags" class="tags-container tags">tshark unicode error</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>15 Sep '11, 19:20</strong></p><img src="https://secure.gravatar.com/avatar/a5a3214300b3b17fc46c3b656b7bed01?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="ylda_ljm0620&#39;s gravatar image" /><p>ylda_ljm0620<br />
...
Stop.</code></pre><p>how should i modify the thark.c？</p></div><div id="comment-6412-info" class="comment-info"><span class="comment-age">(16 Sep '11, 02:10)</span> ylda_ljm0620</div></div><span id="6441"></span><div id="comment-6441" class="comment"><div id="post-6441-score" class="comment-score"></div><div class="comment-text"><p>thanks. It success.</p><p>i add shell32.lib to tshark_LIBS in Makefile.nmake, add #include &lt;shellapi.h&gt; in tshark.c.</p></div><div id="comment-6441-info" class="comment-info"><span class="comment-age">(18 Sep '11, 20:19)</span> ylda_ljm0620</div></div></div><div id="comment-tools-6428" class="comment-tools"></div><div class="clear"></div><div id="comment-6428-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
