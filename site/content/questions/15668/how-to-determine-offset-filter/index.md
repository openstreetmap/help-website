...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-15668-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I need to capture NLTMv1 and v2 traffic. Does this require an offset and if so how does one go about determining the offset value for a filter?</p></div><div id="question-tags" class="tags-container tags">ntlm offset</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>07 Nov '12, 15:55</strong></p><img src="https://secure.gravatar.com/avatar/1c1917f4335764246c2c90d4d2e8f785?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="ry6&#39;s gravatar image" /><p>ry6<br />
