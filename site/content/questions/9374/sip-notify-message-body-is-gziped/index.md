...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-9374-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I am looking to find out if Wireshark can decode the Body of a SIP Notify when the body is gzipped by the sender. I can see the SIP header, but just not the body.</p><p>Thanks.</p></div><div id="question-tags" class="tags-container tags">body gzip sip</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>05 Mar '12, 17:37</strong></p><img src="https://secure.gravatar.com/avatar/f63fd202ed54195f69998fc01c57f3fd?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="decodeme&#39;s gravatar image" /><p>decodeme<br />
