...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-12385-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, I captured some traffic on my linux, and l want to be able using tshark to get the data in the ascii format with out the hex format. is there some flag i can use for that? (i only found -x which gives both ascii and hex)</p><p>thanks</p></div><div id="question-tags" class="tags-container tags">ascii tshark</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>03 Jul '12, 00:29</strong></p><img src="https://secure.gravatar.com/avatar/cd32499a16a71ad8594db755a1d97faf?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="silvik&#39;s gravatar image" /><p>silvik<br />
