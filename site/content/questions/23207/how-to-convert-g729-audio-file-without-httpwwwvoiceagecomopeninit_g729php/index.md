...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-23298-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>how to play audio/voice in g729 codec capture file by using wireshark</p></blockquote><p>There is no way, as Wireshark does not support that codec. However, you can try to save the recorded audio stream and then try to convert it with <a href="http://sox.sourceforge.net/">sox</a> or <a href="http://www.germanixsoft.de/">GermaniX Transcoder</a>.</p><p>Anyway, the conversion part is a question you better ask in a VoIP forum.</p><p>Regards<br />
