...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-62237-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'd greatly appreciate any guidance on troubleshooting an issue with HTTPS sessions between Hyper-V hosts (hyper-v replication).</p><p>I'm convinced network issues are the root cause, but I can't put my finger on it.</p><p><a href="https://www.cloudshark.org/captures/f82f57724e4f">Capture at Gateway, LAN interface, client side</a></p></div><div id="question-tags" class="tags-container tags">analysis https</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>22 Jun '17, 08:49</strong></p><img src="https://secure.gravatar.com/avatar/1e2248ffe211b38de2fb9be2943c4308?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Velas&#39;s gravatar image" /><p>Velas<br />
