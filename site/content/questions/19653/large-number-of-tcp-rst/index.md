...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-19653-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm seeing a large number of tcp rst and am not quite sure what is causing it. I would appreciate any help. Below is that capture.</p><pre><code>No. Time Source Destination Protocol Length Info
...
Public_Secure 10.1.1.4 443 Standard</p></div><div id="comment-19658-info" class="comment-info"><span class="comment-age">(19 Mar '13, 12:06)</span> mp84057</div></div></div><div id="comment-tools-19656" class="comment-tools"></div><div class="clear"></div><div id="comment-19656-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
