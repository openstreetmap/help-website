...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-41738-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hello! First time user here.</p><p>My concern is if the business transaction data such as sales, names, etc. Will they be captured in WireShark?</p><p>If so, Is this an option that can be turned off?</p><p>I read through the FAQ but didn't find the answers. Thanks In Advance.</p><p>Thanks Ken.</p></div><div id="question-tags" class="tags-container tags">data business</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>23 Apr '15, 12:23</strong></p><img src="https://secure.gravatar.com/avatar/51b6de15fd404cad66e26477db1b5c3c?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="saytoben&#39;s gravatar image" /><p>saytoben<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-41741-score" class="post-score" title="current number of votes">2</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>My concern is if the business transaction data such as sales, names, etc. Will they be captured in WireShark?</p></blockquote><p>That's not a problem you can fix in Wireshark. If data is transmitted without being encrypted, everybody can capture and read that information, no matter if he is using Wireshark, Ettercap, tcpdump or any other sniffer.</p><p>The only solution: Use encryption (like SSL/TLS) if you have to transmit sensitive data over a network.</p><p>Regards<br />
