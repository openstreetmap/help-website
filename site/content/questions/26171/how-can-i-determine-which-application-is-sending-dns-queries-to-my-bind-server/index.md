...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-26234-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>I'm on Fedora. Can you explain how to do this a bit?</p></blockquote><p>First install systemtap</p><blockquote><p><a href="https://sourceware.org/systemtap/wiki/SystemtapOnFedora">https://sourceware.org/systemtap/wiki/SystemtapOnFedora</a></p></blockquote><p>Then, if you kernel supports CONFIG_UTRACE, you can run the following script</p><pre><code>#!/usr/bin/env stap
