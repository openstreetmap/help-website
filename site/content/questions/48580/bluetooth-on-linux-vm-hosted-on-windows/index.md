...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-48580-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I think I just answered my own question, but if I cannot capture Bluetooth traffic using Wireshark on a Windows laptop, I'm probably not going to be terribly successful capturing Bluetooth traffic using Wireshark on a Linux VM hosted on that same Windows laptop, am I?</p><p>Thanks, John</p></div><div id="question-tags" class="tags-container tags">bluetooth vmware linux</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>16 Dec '15, 11:44</strong></p><img src="https://secure.gravatar.com/avatar/674a1eaa580f91629e6178ba8e75a8fa?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="JohnG&#39;s gravatar image" /><p>JohnG<br />
