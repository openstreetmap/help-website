...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-26471-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>Please run the following command and check if there are any differences regarding the ownership and access rights of those devices.</p><blockquote><p>ls -al /dev/bpf[0-4]</p></blockquote><p>If so, please adjust the other devices to what you see for /dev/bpf0.</p><p>Regards<br />
