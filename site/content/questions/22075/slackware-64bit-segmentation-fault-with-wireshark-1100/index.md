...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-22075-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I just built and installed wireshark-1.10.0 (as root) It compiled normally with a few typical warnings.</p><p>When I run it (as root) I get a Segmentation fault</p><p>When I debug with gdb I get the following backtrace</p><pre><code>Program received signal SIGSEGV, Segmentation fault.
