...
<p>I have completed a local Nominatim installation with California (USA) added and the entire tiger database already parsed as per the <a href="https://wiki.openstreetmap.org/wiki/Nominatim/Installation">documentation</a>. Now I want to add the rest of North America as well. My questions are:</p>
<ol>
...
<li>Can I assume that the tiger and wiki bins mentioned in the same <a href="https://wiki.openstreetmap.org/wiki/Nominatim/Installation">documentation</a> will not need to be processed again as they are independent of the state ?</li>
...
<p>The relevant answers are over <a href="/questions/30492/updating-n-america-data-to-planet-data">here</a> and over <a href="/questions/15505/import-more-osm-files-in-to-nominatim">here</a>.</p>
</div>
