...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-15341-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Can Wireshark be compiled with libgnutls version greater than 3? I'm trying to compile on OpenSuSE 12.1, which has libgnutls 3.0.3 and am getting errors when I run configure. If it can be compiled with libgnutls version greater than 3, how can I force configure to accept the version?</p></div><div id="question-tags" class="tags-container tags">libgnutls</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>29 Oct '12, 11:46</strong></p><img src="https://secure.gravatar.com/avatar/0069f852a157ef656a0aaf630027a0b2?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="swadlow&#39;s gravatar image" /><p>swadlow<br />
