...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-49762-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have created a lua plugin, all i want is ability to define a keyboard shortcut for it. currently it is accessible from tools menu, is there a way by which i can assign an accelerator to it?</p></div><div id="question-tags" class="tags-container tags">lua wireshark plugin</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>03 Feb '16, 02:32</strong></p><img src="https://secure.gravatar.com/avatar/c97827713cf7e4148c1f3ff32d4e03b9?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="himanshu97&#39;s gravatar image" /><p>himanshu97<br />
