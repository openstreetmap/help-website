...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-30182-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>When i give command "start capture" in my application it should start capturing and same goes with filtering protocol.</p></blockquote><p>just start Wireshark with the appropriate commandline options in your application. See <a href="http://www.wireshark.org/docs/man-pages/wireshark.html">Wireshark man page</a>.</p><p>Regards<br />
