...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-61323-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>How to define <code>NEW</code> and <code>ESTABLISHED</code> TCP packet based on TCP flags? I would think that <code>NEW</code> TCP packet has <code>SYN</code> flag set, <code>ACK</code> flag not set, <code>RST</code> flag not set, <code>FIN</code> flag not set and value of the rest of the flags is not important:</p><pre><code>NS CWR ECE URG ACK PSH RST SYN FIN
