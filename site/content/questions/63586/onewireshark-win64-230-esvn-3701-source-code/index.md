...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-63586-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hello everyone, I'm using wireshark to decode a captured file of Ericsson OCS for Telco which used Diameter protocol. I tried "Decode As ..." but some command codes still Unknown. I found that OneWireshark-win64-2.3.0-ESVN-3701 is able to understand these command codes but I cannot find out the source code of this version from the official website of Wireshark. Could you please tell me how I can download the source code of "OneWireshark-win64-2.3.0-ESVN-3701" ?</p><p>Thank you very much.</p></div><div id="question-tags" class="tags-container tags">ericsson onewireshark</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>12 Sep '17, 02:04</strong></p><img src="https://secure.gravatar.com/avatar/824a7342f59ff90e6040505b38626416?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="hoangsonk49&#39;s gravatar image" /><p>hoangsonk49<br />
