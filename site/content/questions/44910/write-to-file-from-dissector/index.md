...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-44910-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm trying to print a specific data inside my Wireshark Custom Dissector to a file that I can upload to a different program. I tried opening and writing to a data using <code>fopen</code> and <code>fprintf</code> but Wireshark crashes when I upload my captured packet it crashes. Is there any way I can write a print-to-file function inside a custom dissector?</p></div><div id="question-tags" class="tags-container tags">print outwrite io.write export file</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>06 Aug '15, 14:40</strong></p><img src="https://secure.gravatar.com/avatar/66d32f7338820e81bed11c109bb8eaea?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="J1Ronnie&#39;s gravatar image" /><p>J1Ronnie<br />
