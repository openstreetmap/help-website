...
<p>some helpful tags: If you can swim, you can use leisure=swimmimg_pool <a href="http://wiki.openstreetmap.org/wiki/Tag:leisure%3Dswimming_pool">http://wiki.openstreetmap.org/wiki/Tag:leisure%3Dswimming_pool</a> If it is a plain shower only (like on highway rest areas et al.): amenity=shower <a href="http://wiki.openstreetmap.org/wiki/Tag:amenity%3Dshower">http://wiki.openstreetmap.org/wiki/Tag:amenity%3Dshower</a> there is also a proposed feature: leisure=hot_spring <a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Hot_Spring">http://wiki.openstreetmap.org/wiki/Proposed_features/Hot_Spring</a> - if it is a thermal bath it can be useful and I already used it myself.</p>
