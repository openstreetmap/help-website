...
<p>For example, <a href="http://www.openstreetmap.org/way/78025193#map=15/48.6335/2.1532">this road</a> and <a href="http://www.openstreetmap.org/way/131297913#map=15/48.6335/2.1422">this road</a> are one "split road". You'll notice they both are mapped <code>oneway=yes</code>, <code>highway=motorway</code>, <code>ref=A 10</code>, and both have the same <code>name</code> (<code>L'Aquitaine</code>).</p>
<blockquote>
