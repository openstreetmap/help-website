...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-11209-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I want to parse all files in a directory using a Lua tap. The tap is already working, but the problem now is opening snoop files from Lua in <code>tshark</code>. When I try this:</p><pre><code>for filename in Dir.open(&quot;D:/snoop/&quot;,&quot;snoop&quot;)
do
