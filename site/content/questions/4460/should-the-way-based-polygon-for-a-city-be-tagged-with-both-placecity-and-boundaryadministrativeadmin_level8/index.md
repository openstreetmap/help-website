...
<p>Here's the outline polygon for my favorite city: <a href="https://www.openstreetmap.org/browse/way/33261354">https://www.openstreetmap.org/browse/way/33261354</a></p>
...
<p>Check out the "As Areas" section in the wiki page for <a href="https://wiki.openstreetmap.org/wiki/Key:place">place</a>. One suggestion there is to mark a node as the "centre" of the city (where the name will go) with place=city. Create a boundary=administrative relation for the perimeter (with the appropriate admin level), and make the node a member of the relation with role=admin_centre. See also the <a href="https://wiki.openstreetmap.org/wiki/Relation:boundary">Relation:boundary</a> page.</p>
</div>
