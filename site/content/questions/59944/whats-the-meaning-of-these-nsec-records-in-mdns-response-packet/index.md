...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-59944-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I got a mDNS response like this, can't understand the NSEC records in additional records section. According to rfc 6762, NSEC record in the Additional Section indicates nonexistence of record, but in the Answers Section, it does exist. So what does this mean?</p><pre><code>Multicast Domain Name System (response)
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-59972-score" class="post-score" title="current number of votes">2</div></div></td><td><div class="item-right"><div class="answer-body"><p>Hello jfly</p><p>It looks like the mDNS responder has implemented an option from RFC6762:</p><pre><code>   On receipt of a question for a particular name, rrtype, and rrclass,
