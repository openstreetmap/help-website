...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-45845-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count">1</div></div></td><td><div id="item-right"><div class="question-body"><p>Suppose I have a custom protocol called cust_prot. One of the field is of 4 bytes length and has a flag bit as follows:</p><pre><code>      The 5th bit of the 2nd byte of this field is a flag variable.</code></pre><p>So, I wanted to know what will be the data structure. I have made the following structure but am not sure whether we need to do masking or not.</p><pre><code>     .
     .
     { &amp;hf_cust_prot_skip5,
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-45848-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><pre><code> { &amp;hf_cust_prot_cap1,
     { &quot;CUST PROT CAP1&quot;, &quot;cust_prot.skip5.cap1&quot;,
     FT_BOOLEAN, 32,
