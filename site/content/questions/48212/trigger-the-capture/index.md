...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-48212-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi there,</p><p>is it possibe to set a trigger to start the caption? I mean, wireshark is running and waiting for an condition, e.g. a packet to a strange socket, and then starts with captureing in a file (with stop-condition set in the Capture-Interface-Options) or a ringbuffer.</p><p>Thanks for Your Support, Bernhard Hauser</p></div><div id="question-tags" class="tags-container tags">capture trigger</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>02 Dec '15, 13:33</strong></p><img src="https://secure.gravatar.com/avatar/5df15cb7413a11a5897331507b8d9631?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Uri&#39;s gravatar image" /><p>Uri<br />
