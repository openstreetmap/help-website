...
<span class="accept_rate" title="Rate of the user&#39;s accepted answers">accept rate:</span> <span title="Randy Rohrbach has no accepted answers">0%</span></p></div><div class="post-update-info post-update-info-edited"><p>edited 18 Oct '16, 01:51</p><img src="https://secure.gravatar.com/avatar/285b1f0f4caadc088a38c40aea22feba?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Lekensteyn&#39;s gravatar image" /><p>Lekensteyn<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-56489-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>At the moment the Lua API throws errors whenever something unusual happens. This shows nicely in the tree, but it is not natural to the Lua programmer. As a workaround you can use <a href="https://www.lua.org/manual/5.2/manual.html#pdf-pcall"><code>pcall</code></a> to catch the error and prevent it from propagating:</p><pre><code>local success, eth_dissector = pcall(Dissector.get, &quot;eth_withoutfcs&quot;)
