...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-26579-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>How to implement the solution in Amazon Linux AMI (it's not Ubuntu)?</p></blockquote><p>Amazon AMI is based on CentOS.</p><p>So, please do this:</p><blockquote><p>yum install wireshark<br />
