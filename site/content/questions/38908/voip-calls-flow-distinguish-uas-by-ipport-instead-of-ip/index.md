...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-38908-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>This feature is very handy to display in a clear way a complex call flow. But unfortunately it is almost unusable in case User-Agents share the same IP address and talk together. Resulting graph is flat with only one speaker talking to itself and no information attached to messages, only ports and arrow.</p><p>That's why I'm wondering : is there any way to distinguish speakers (i.e. UAs) by something more than only IP address, ideally IP address + port ? That would be great!</p><p>TIA</p></div><div id="question-tags" class="tags-container tags">analysis flow calls voip</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>06 Jan '15, 08:46</strong></p><img src="https://secure.gravatar.com/avatar/3b1fab5ab8c0ed8832fb901d5ef65cb2?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="JuLu&#39;s gravatar image" /><p>JuLu<br />
