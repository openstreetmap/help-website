...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-38449-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I was trying to capture Netflow traffic from a device to my NMS server. I wanted to use the CFLOW decode as option under transport. I couldnt see transport window under decode as option. Is there a wayi Can enable this? All the protocols option is already checked.</p><p>Regards, K.B.L</p></div><div id="question-tags" class="tags-container tags">cflow</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>08 Dec '14, 13:16</strong></p><img src="https://secure.gravatar.com/avatar/25a53375c677a86f4b00d0bc44468c28?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="KBL&#39;s gravatar image" /><p>KBL<br />
