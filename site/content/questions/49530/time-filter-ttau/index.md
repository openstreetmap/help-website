...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-49530-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I want to create a filter where it capture packet from X time to X+10 secs Example: The packet i click, it take its time and add 10 secs to its time and show only those packets that are only in this time range.</p><p>Scope_: * How i can get automatically the time of packet where i click. %%frame.time is static if i save the filter. i need to create dynamic filter * How to add 10 secs from above mentioned time</p><p>Thanks</p></div><div id="question-tags" class="tags-container tags">frame.time</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>27 Jan '16, 02:19</strong></p><img src="https://secure.gravatar.com/avatar/e57ca27b0c054972a3bc8e5329413614?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="mi121647&#39;s gravatar image" /><p>mi121647<br />
