...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-59895-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi. I have installed wireshack and would like to find a basic guide which will tell me how I can monitor specific applications such as Skype, Pidgin etc. The goal is to see if these applications are leaking DNS or my IP address, even with a VPN being used. Is there a basic guide on how I can achieve this in Wireshark?</p></div><div id="question-tags" class="tags-container tags">monitor</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>07 Mar '17, 10:00</strong></p><img src="https://secure.gravatar.com/avatar/d69e6b687757a878d7ed7860a0c0eed9?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Soldier&#39;s gravatar image" /><p>Soldier<br />
