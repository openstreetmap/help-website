...
<p>As <a href="http://help.openstreetmap.org/users/647/sk53">@SK53</a> suggested use 'around' filter with overpass api for all <a href="http://wiki.openstreetmap.org/wiki/Key:amenity">amenities</a>. Here is the example:</p>
<pre><code>/*
