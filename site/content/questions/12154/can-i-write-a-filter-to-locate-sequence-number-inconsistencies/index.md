...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-12157-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>you can use this command:</p><blockquote><p><code>tshark -r icmp.cap -R "ip.src == x.x.x.x" -T fields -e frame.number -eip.src -e icmp.seq -E header=y -E separator=;</code><br />
