...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-16605-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>If you just want the tabs instead of the spaces, pipe the output of tshark to sed/tr/awk (whatever you prefer) and replace the spaces with a tab.</p><p>Example for tr:</p><blockquote><p><code>tshark -tad -n -r input.cap | tr ' ' \\t &gt; output.txt</code><br />
