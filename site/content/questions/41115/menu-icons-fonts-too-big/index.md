...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-41115-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, I'm running Wireshark 1.12 on Ubuntu Linux, but my screen is very small, 10'inc of a netbook. All dropdown menus, setting menus and icons are too big, and don't fit in the monitor. I practically can't see any settings!<br />
