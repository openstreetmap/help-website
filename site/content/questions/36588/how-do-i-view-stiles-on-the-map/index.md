...
<p>However, it is possible to search for map features that aren't displayed on the "standard" map. Perhaps the easiest way is via "<a href="http://wiki.openstreetmap.org/wiki/Overpass_turbo">Overpass Turbo</a>". First I did a "<a href="http://wiki.openstreetmap.org/wiki/TagInfo">taginfo</a>" search for the thing that I was looking for:</p>
<p><a href="http://taginfo.openstreetmap.org/tags/barrier=stile">http://taginfo.openstreetmap.org/tags/barrier=stile</a></p>
<p>(this method does mean that you need to <a href="http://wiki.openstreetmap.org/wiki/Beginners_Guide_1.4.1">know a little bit about OSM tags</a>, unfortunately)</p>
...
<p>It may well be that after looking at the stiles in Lyme Park via Overpass that you say "hang on - many stiles are missing!". However, it's pretty straightforward to either edit the map to add them, or to add notes so that other people can. This "<a href="http://www.openstreetmap.org/welcome">welcome</a>" page has more information.</p>
...
&#10;</div>
<div class="comment-text">
<p><a href="http://help.openstreetmap.org/users/9596/ringi">@ringi</a> another alternative is wikimedia commons</p>
</div>
...
&#10;</div>
<div class="comment-text">
<p>A minor experiment with MapCSS and the overpass query in <a href="http://help.openstreetmap.org/users/387/someoneelse">@SomeoneElse</a>'s answer. Adding : "{{style: node[barrier=stile] { icon-image: url('icons/maki/triangle-12.png'); icon-width: 12; } }}" visualised the stiles, albeit with an abstract black triangle. Now to create some stile icons.</p>
</div>
