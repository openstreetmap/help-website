...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-14811-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I tried to use the latest wireshark &amp; tshark of version 1.90, I tried to follow tcp stream with tshark in following options:<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-14826-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>But I just can get one session between the client and server, and I want get all of the sessions, so any tips?</p></blockquote><p>that's only possible with scripting. You can try this:</p><ol><li>print all TCP stream numbers for the desired server/port combination.</li><li>use that list to extract all streams.</li></ol><p><code> for stream in `tshark -r follow_tcp.pcap -R "ip.addr eq 127.0.0.1 and tcp.port eq 5678" -T fields -e tcp.stream | sort -n -u`; do echo Stream: $stream; tshark -r follow_tcp.pcap -q -z follow,tcp,ascii,$stream; done</code></p><p>The other option is to use <strong>tcpflow</strong></p><blockquote><p><code>http://ask.wireshark.org/questions/10023/command-line-option-for-follow-tcp-stream</code><br />
