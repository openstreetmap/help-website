...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-10197-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>The Quick Setup only provided for UNIX and Windows. For UNIX, it did not give enough information on how to compile/build the wireshark exact what it gives the instruction for Windows.<br />
</p><p>The reason why I ask for the instruction on how to compile/build wireshark is because I need to run Fortify against wireshark on RHEL (Red Hat Enterprise Linux).</p></div><div id="question-tags" class="tags-container tags">fortify rhel redhat</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>16 Apr '12, 12:28</strong></p><img src="https://secure.gravatar.com/avatar/2f69584b1f741b1c3f17dbed5896a927?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Turyturbo&#39;s gravatar image" /><p>Turyturbo<br />
