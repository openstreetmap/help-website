...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-51875-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm trying to copy json from a POST'ed request. I can see the json in two different formats, but none of them easily copyable.</p><p>Any suggestions how to get the json out of request in a simple way?</p><p><img src="http://i63.tinypic.com/6o390w.png" alt="json place " /></p><p><img src="http://i67.tinypic.com/2ef3tyr.png" alt="json place 2" /></p></div><div id="question-tags" class="tags-container tags">json copy request copying</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>22 Apr '16, 08:27</strong></p><img src="https://secure.gravatar.com/avatar/f7efa95364507635a0021a1231eb6b65?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Aleksander&#39;s gravatar image" /><p>Aleksander<br />
