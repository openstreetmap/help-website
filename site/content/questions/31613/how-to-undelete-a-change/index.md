...
<p>As you already know identifying the changeset (for complete reversion) and individual object ids (for minor undeletes) is the most useful information to start with. In your case the deleted object is a nodes: <a href="https://www.openstreetmap.org/node/356756834">356756834</a>. The other tower looks fine, although it is attached to a road: <a href="https://www.openstreetmap.org/node/356756961/history">356756961</a>. So this is a simple case and the undelete option (on JOSM File menu) can be used.</p>
<ol>
