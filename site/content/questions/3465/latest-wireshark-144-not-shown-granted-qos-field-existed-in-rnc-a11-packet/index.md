...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-3465-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I opened the file A11-RNC-PCF.pcap with Wireshark 0.99.5 and found the ‘Granted QoS’ field in the A11 Reg Request packet from RNC to PDSN. But unfortunately if I used Wireshark version 1.4.4 there are not such field existed!? It quite mislead our customers who used latest version of Wireshark. Is this some bug? Below is parsed part of Wireshark output:</p><pre><code>Extension: Normal Vendor/Organization Specific Extension
