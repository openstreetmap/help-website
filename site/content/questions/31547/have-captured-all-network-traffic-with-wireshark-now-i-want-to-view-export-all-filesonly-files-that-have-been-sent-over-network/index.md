...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-31547-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, I have captured all network traffic with wireshark. now i want to view (export) all files(only files) that have been sent over network. Is it possible ? how to do that?</p></div><div id="question-tags" class="tags-container tags">file</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>05 Apr '14, 06:14</strong></p><img src="https://secure.gravatar.com/avatar/3c58a493605601b7b484885df88a0779?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="hasanaliyev555&#39;s gravatar image" /><p>hasanaliyev555<br />
