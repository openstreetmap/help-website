...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-62337-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>You could probably use tshark to do something like that, printing relative time of each frame with the ACK_RTT as columns, e.g.</p><pre><code>[C:\]tshark -r &quot;Sample.pcapng&quot; -Tfields -e frame.time_relative -e tcp.analysis.ack_rtt
0.000000000
