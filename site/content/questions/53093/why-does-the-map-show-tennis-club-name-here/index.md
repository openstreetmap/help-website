...
&#10;</div>
<div class="comment-text">
<p>Thanks Simon, I'd agree that name position is possibly a rendering issue especially given that everything displays ok on OsmAnd. My original intention of using a multi-polygon was to 'unify' all elements relating to the tennis club (overall area, actual courts, clubhouse, parking) in a single feature. Possibly this was misguided - I'm very much at 'toe-in-the-water' stage so far as multi-polygons / relations are concerned. I've now added the name of the club to the building although I have still left it on the area outline. Maybe it shouldn't be on both? Perhaps I should be using something similar to mapping school premises as a guideline <a href="https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dschool">https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dschool</a></p>
</div>
