...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-30511-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I've created a plugin using windows and it builds and runs correctly. I'm trying to get the plugin to build on CENTOS6 using Wireshark 1.10.5 and I'm having some issues with the Makefiles. The downloaded source builds fine. The issue starts once I add the plugin. After editing the root, plugins, and my plugin directory Makefiles I keep getting the below error.<br />
