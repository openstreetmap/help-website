...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-37536-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>You can use thsark in the following way</p><blockquote><p>tshark -nr ssl_example.pcap -Y "ssl.handshake.ciphersuites" -Vx &gt; ssl.output.txt</p></blockquote><p>Sample output:</p><pre><code>Secure Sockets Layer
