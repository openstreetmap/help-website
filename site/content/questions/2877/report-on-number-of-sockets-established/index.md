...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-2880-score" class="post-score" title="current number of votes">2</div></div></td><td><div class="item-right"><div class="answer-body"><p>You can use <code>tshark</code> to achieve these kind of statistics:</p><pre><code>$tshark -r tmp.cap -R &quot;tcp.flags==16 &amp;&amp; tcp.seq==1 &amp;&amp; tcp.ack==1 &amp;&amp; tcp.len==0&quot; -T fields -e ip.src | sort -n | uniq -c
   1 192.168.1.20
  23 192.168.1.242
   1 192.168.1.4
   2 192.168.2.103
