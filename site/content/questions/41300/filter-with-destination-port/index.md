...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-41300-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count">1</div></div></td><td><div id="item-right"><div class="question-body"><p>Hello, the IP I am connecting to can change, but it always uses 2 destination ports (for example purposes, 00000 and 11111).</p><p>Let me know what to put in the filter list.</p></div><div id="question-tags" class="tags-container tags">filter ip destination ports</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>08 Apr '15, 13:47</strong></p><img src="https://secure.gravatar.com/avatar/735a10a946b993f50599349073007243?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="BobTheLawyer&#39;s gravatar image" /><p>BobTheLawyer<br />
