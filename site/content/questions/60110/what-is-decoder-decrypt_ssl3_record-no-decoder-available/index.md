...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-60110-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hello Team, Can someone help me to understand why we can't decrypt SSL communication? This is capture on windows 2008 web server. One thing that stands out from trace are the following: no decoder available</p><p>decrypt_ssl3_record: using client decoder decrypt_ssl3_record: no decoder available</p><p>Any comment or feedback appreciated. Thank u</p><p>Wireshark SSL debug log :</p><pre><code>Wireshark version: 2.2.5 (v2.2.5-0-g440fd4d)
