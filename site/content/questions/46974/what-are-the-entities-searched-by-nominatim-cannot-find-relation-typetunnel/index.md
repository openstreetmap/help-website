...
description = '''I was searching for this relation by name, but Nominatim finds no results: https://www.openstreetmap.org/relation/5519843#map=15/50.1009/14.4076 - however it seems that Nominatim should be able to search in relations as well. (Note that the ways inside this relation have their own, different names, a...'''
...
<p>I was searching for this relation by name, but Nominatim finds no results: <a href="https://www.openstreetmap.org/relation/5519843#map=15/50.1009/14.4076">https://www.openstreetmap.org/relation/5519843#map=15/50.1009/14.4076</a> - however it seems that Nominatim should be able to <a href="/questions/45347/nominatim-should-search-relations">search in relations</a> as well.</p>
...
<p>Particularly given that the addition of tunnel relations seem to be a stealth edit here <a href="https://wiki.openstreetmap.org/w/index.php?title=Key:tunnel&amp;oldid=1082393">https://wiki.openstreetmap.org/w/index.php?title=Key:tunnel&amp;oldid=1082393</a> and as you can see only a tiny number of objects are actually tagged that way.</p>
