...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-60565-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><ol><li><p>I think this is the comment of the code block in question, taken from <a href="https://raw.githubusercontent.com/boundary/wireshark/master/epan/dissectors/packet-tcp.c">packet-tcp.c</a>:</p><pre><code>/* DUPLICATE ACK
