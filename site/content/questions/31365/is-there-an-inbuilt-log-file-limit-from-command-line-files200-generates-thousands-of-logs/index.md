...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-31365-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>Is there an inbuilt Log File limit from command line. files:200 generates thousands of logs.</p><p>At 200, i get many thousands of log files. I stopped them at 20,000 manually.</p><p>"C:\Program Files\Wireshark\Wireshark.exe" -i "Local Area Connection" -k -w "C:\SOE\Logs\NetCap.pcapng" -N "mntC" -t ad -b filesize:10000 -b files:200</p></div><div id="question-tags" class="tags-container tags">command limit log file line.</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>01 Apr '14, 21:45</strong></p><img src="https://secure.gravatar.com/avatar/c95b60dcb8f2b864bdcd9bb2bfed3e78?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="timekeeper5150&#39;s gravatar image" /><p>timekeeper5150<br />
