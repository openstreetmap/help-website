...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-24802-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm working on reverse engineering an online game (League of Legends). While a lot of traffic is unencrypted and easily available through your great tool, is some data e.g. the chat, pub-private key encrypted. I know I can add this private key to wireshark to monitor the data, but how can I find the private key?</p><p>It must be on my computer since the game is able to connect. It can be in the executable, but it should be possible to retrieve non the less, or am I wrong?</p><p>Any help or pointers would be greatly appreciated!</p></div><div id="question-tags" class="tags-container tags">private rsa key reverse-engineering</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>17 Sep '13, 03:42</strong></p><img src="https://secure.gravatar.com/avatar/00b7b76f66d194878bb23a73f6a119dd?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="ramvi&#39;s gravatar image" /><p>ramvi<br />
