...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-46215-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>The proto_tree_add_item displays each filter in a newline in the CLI. Is there a way to display the filters in the same line.</p><p>Ex.</p><pre><code>    proto_tree_add_uint(tree, hf_s1, tvb, 0, 1, s1);    
