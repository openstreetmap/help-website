...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-26485-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>Is there a way to solve this?</p></blockquote><p>If you are in the <code>Packet Details</code> pane, press <strong>CRTL-SHIFT-TAB</strong> and Wireshark will change the focus to the <code>Packet List</code> pane. By doing so, it will 'jump' into that pane and highlight the previously selected frame.</p><p>That's how I 'solve' this problem for me, until there is a better solution :-)</p><p>Regards<br />
