...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-34248-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>i am trying to see ldap search requests for the telephonenumber attribute and the responses so i can see the service response time statistics when a certain attribute is searched on. to find the search frames i would use "ldap.attributeDesc contains "phone"" but is it possible to also display the frame listed in "response_in"?</p></div><div id="question-tags" class="tags-container tags">display-filter response ldap</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>27 Jun '14, 12:05</strong></p><img src="https://secure.gravatar.com/avatar/6b7b865f6c6006f4249b495230cb0397?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="410sean&#39;s gravatar image" /><p>410sean<br />
