...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-55388-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>My PC is connected to D-Link router via ethernet cable while my android phone is connected to the same router via wifi. How can i see the packet from android phone on my pc. I used to use fiddler. But have no idea about how to do it here. PLEASE help</p></div><div id="question-tags" class="tags-container tags">router android wifi</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>07 Sep '16, 23:55</strong></p><img src="https://secure.gravatar.com/avatar/bbe634a2f6507ee8463bf05fbe7da81a?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Katsuga50&#39;s gravatar image" /><p>Katsuga50<br />
