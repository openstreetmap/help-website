...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-3218-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Wireshark Version 1.4.2; Win7Pro64; 802.11 sniffing. Does the presence of the "Capture packets in promiscuous mode" option box imply that it is, in fact, possible to put my adapter into promiscuous mode? The box is present, and is checked, yet I am only seeing traffic to or from the machine running Wireshark, suggesting that it is not really in promiscuous mode.</p><p>Thanks, Howard</p></div><div id="question-tags" class="tags-container tags">wireless windows7 promiscuous</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>29 Mar '11, 17:50</strong></p><img src="https://secure.gravatar.com/avatar/52d67f1a733af0acc0310b8313fc21e2?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="hdelman&#39;s gravatar image" /><p>hdelman<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-3219-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>The check box doesn't mean that the interface can go into promiscuous mode. If it is checked it will attempt to put it into promiscuous mode. I have some wireless adapters that when it is checked, it doesn't capture at all.<br />
