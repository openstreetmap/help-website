...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-27018-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Folks,</p><p>Is there to way to get successful vs unsuccessful calls in a given pcap using tshark command line? I am using the example below and get some stats, but would need more. Also, no matter which pcap I use, the average set up is always showing up as 0, what am i missing?(there are definitely a lot of successfull calls in the files i am reading)</p><p>tshark -r sharktest.pcap -q -z sip,stat</p><pre><code>===================================================================
SIP Statistics
