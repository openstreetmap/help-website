...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-35344-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I am creating an installer using NSIS. I want to detect whether user has installed correct version of Wireshark in his/her system or not. e.g. version 1.10.8. If this version is installed, then installer should proceed otherwise it should abort. I have created a basic code as shown below but don't know about how to detect the correct version. Following is my code:</p><pre><code>page license
page directory
Page instfiles
