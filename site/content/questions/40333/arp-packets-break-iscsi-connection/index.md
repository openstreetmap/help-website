...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-40353-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>Is there any logic to why an ARP packet would break an iSCSI stream?</p></blockquote><p>no, unless there is a catastrophic bug in the TCP/IP stack of the involved systems.</p><blockquote><p>Tcpdump-uw at the host reveals a 9.9 sec delay (tcp.time_delta) right after ARP broadcast message.</p></blockquote><p>That's (most certainly) just be a coincidence.</p><p>Regards<br />
