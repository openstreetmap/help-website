...
<p>This is in the interest of tagging a la <a href="/questions/84812/">my prior question</a> to avoid messing with the underlying objects. Part of the intent is for expansion, bringing more woodlands outside the boundary into the larger relation where appropriate. So far, though, the approach doesn't seem to work, failing to render the woods at all in default Carto on the OSM site. How do I accomplish what I need here?</p>
</div>
