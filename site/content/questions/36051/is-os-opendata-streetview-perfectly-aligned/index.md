...
<p>I have found in the past that Bing imagery can be offset by a few metres, as a result of the difficulty of converting aerial images to georeferenced maps. As far as I know, it is impossible to do so unless really accurate height information is available. See this question (<a href="/questions/17661/aligning-roads-to-proper-location)">https://help.openstreetmap.org/questions/17661/aligning-roads-to-proper-location)</a> for some more thoughts on that point.</p>
