...
<p>I decided to ask this question after <a href="https://www.openstreetmap.org/user/Pieren/diary/20385#comment24591">a discussion with Pieren</a> and realising that <a href="http://osmose.openstreetmap.fr/en/map/">osmose</a> flags multiple relations per street as <a href="https://wiki.openstreetmap.org/wiki/Osmose/erreurs#Tags_missing">error 2060</a>. Obviously, some people frown upon multiple relations per street and/or relation names that do not match the street name.</p>
...
Anyway, I will repeat my argument here : the relation "associatedStreet" is supposed to represent the street and its house numbers. The tag "name" should not be used for another purpose like routing instructions etc but just give the street name itself (as an optional hint, as said <a href="https://wiki.openstreetmap.org/wiki/Relation:associatedStreet">on the wiki</a>). Otherwise you create unnecessary confusion if the tag name differs between the relation and the highway, especially for newcomers.<br />
