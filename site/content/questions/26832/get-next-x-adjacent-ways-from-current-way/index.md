...
<p>So I want the app to query via the overpass API, and then find for example the next 10 adjacent ways (or the next x adjacent ways within a 2 KM radius) of the current way i'm driving on. If for instance I was driving south on the above road: "<a href="https://www.openstreetmap.org/browse/way/111435507">111435507</a>", the immediate next adjacent way would be: "<a href="https://www.openstreetmap.org/browse/way/111435449">111435449</a>", the next one would be: "<a href="https://www.openstreetmap.org/browse/way/111435478">111435478</a>" etc. Is it possible to create one query that can get all the adjacent ways like this?</p>
