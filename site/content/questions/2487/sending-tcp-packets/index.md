...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-2487-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>How can I see TCP packets that I am sending them?not all TCP packets.</p></div><div id="question-tags" class="tags-container tags">packets tcp</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>22 Feb '11, 09:56</strong></p><img src="https://secure.gravatar.com/avatar/96e902e433f9ca63286cc774486728f8?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="baran&#39;s gravatar image" /><p>baran<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-2490-score" class="post-score" title="current number of votes">2</div></div></td><td><div class="item-right"><div class="answer-body"><p>You can do something like:</p><pre><code>tcp and src host &lt;YOUR_IP&gt;  (capture filter)
