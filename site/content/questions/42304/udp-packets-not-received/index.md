...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-42304-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I am trying to build a socket to retrieve the ethernet packets from ecu. When i run my code on windows there is no problem and the code runs correctly. But when i run my code on Linux it gets stuck at s.recv(65565) as no udp messages are received by Debian(raspberry pi). I have already set static ip in /etc/network/interfaces as follows: <code>iface eth0 inet static  address 160.48.199.91  netmask 255.255.255.0  gateway 160.48.199.1</code></p><p>The code is as below:</p><pre><code> import socket
    import sys
    HOST = &quot;160.48.199.91&quot;
    port = 30490
