...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-59519-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>In case you're unaware, Wireshark can read from multiple interfaces. I have experimented a bit with a possible solution for you using <code>tcpdump</code> and <code>libpcap</code> versions 4.9.0 and 1.8.1, respectively. Below is the contents of a script I ran to successfully test this. Perhaps it's useful to you?</p><p><code></code></p><code></code><pre><code>#!/bin/sh
