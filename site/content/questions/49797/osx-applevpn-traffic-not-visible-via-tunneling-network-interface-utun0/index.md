...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-49797-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>'m running Mac OS/X 10.11, and the VPN is a Apple IPSec VPN. I could verify that the host is routing correctly over the VPN interface (which Mac OS/X calls "utun0")</p><pre><code>$ netstat -rn
Routing tables
