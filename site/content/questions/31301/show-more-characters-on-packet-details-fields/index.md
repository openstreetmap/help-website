...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-31308-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>Please try this:</p><blockquote><p>tshark -nr snmp.pcap -Y "snmp" -T fields -e frame.number -e ip.src -e ip.dst -e snmp.value.octet s -E header=y -E separator=;</p></blockquote><p>If -Y does not work, please use -R instead.</p><p>Then parse the output and convert it to whatever format you need.</p><p>See also the other SNMP fields: <a href="http://www.wireshark.org/docs/dfref/s/snmp.html">http://www.wireshark.org/docs/dfref/s/snmp.html</a></p><p>Regards<br />
Kurt</p><p>Regards<br />
