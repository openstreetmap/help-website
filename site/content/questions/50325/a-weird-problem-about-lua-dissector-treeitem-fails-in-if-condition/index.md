...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-50325-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>this is a simple post dissector code... just add a new protofield with the string “blahblahblah” in the dissect tree.</p><p>The weird thing is if the line “b2=10” is removed, the script works; if it exists, the scripts doesn’t work.</p><pre><code>b1=0
b2=0
