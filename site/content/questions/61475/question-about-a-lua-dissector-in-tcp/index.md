...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-61475-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Here is the thing.</p><ul><li>source port is an ephemeral port and destination port is 5001 (iperf)</li><li>I'm trying to create a dissector which dissects the ACK packets from destination to source port.</li></ul><p>Code 1.</p><pre><code>      local tcp_dissector_table = DissectorTable.get(&quot;tcp.port&quot;)
