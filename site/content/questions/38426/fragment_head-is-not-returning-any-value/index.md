...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-38426-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>While doing Reassembly in my dissector</p><p>fragment_head *fd_head; i have assigned. After declaring table</p><pre><code>  fd_head = fragment_add_seq_next(&amp;mte_reassembly_table,next_tvb, offset_payload, pinfo, 0, NULL,  28, TRUE );
