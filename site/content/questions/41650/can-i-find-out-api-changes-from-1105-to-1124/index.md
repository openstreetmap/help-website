...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-41650-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have a dissector that was programmed in C++ and works under Wireshark 1.10.5. I want to bring it up to 1.12.4, but it seems a number of the API calls are no longer valid (several deprecated ones I can manage). I'm not sure if it would help to post the calls here as well.</p></div><div id="question-tags" class="tags-container tags">api dissector</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>21 Apr '15, 17:03</strong></p><img src="https://secure.gravatar.com/avatar/ec1e1b4494bdd1cb7abc1d914d56847d?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="tvisitor&#39;s gravatar image" /><p>tvisitor<br />
