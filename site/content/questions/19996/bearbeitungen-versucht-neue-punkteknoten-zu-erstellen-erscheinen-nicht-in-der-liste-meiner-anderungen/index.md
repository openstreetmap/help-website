...
<p>habe ich vielleicht bei den keys bzw values einen fehler gemacht? bearbeitet habe ich via potlach2 - schade das es da noch kein drag&amp;drop symbol für cctv gibt. deshalb habe ich ja dann via "advanced" die keys versucht zu setzen...</p>
...
<p>Wenn deine Bearbeitung nicht in der Chronik und in deiner Liste der Änderungssätze erscheint, dann wurde sie wohl nicht gespeichert. Oder etwas ist sehr ungewöhnlich... was mir hier der Fall zu sein scheint. <a href="https://www.openstreetmap.org/user/anzed">https://www.openstreetmap.org/user/anzed</a> führt eine "3" hinter "Bearbeitungen" auf, was heißt, dass du 3 Änderungssätze haben solltest; <a href="https://www.openstreetmap.org/user/anzed/edits">https://www.openstreetmap.org/user/anzed/edits</a> zeigt aber keine. Vielleicht haben die Server zur Zeit ein paar Probleme (<span>Probleme wurden bisher aber nicht gemeldet</span>). Von anderen Benutzern kommen aber Änderungssätze rein: <a href="https://www.openstreetmap.org/browse/changesets">https://www.openstreetmap.org/browse/changesets</a></p>
...
<p>Die Inhalte der Tags sind Potlatch2 und dem Server völlig egal - du kannst auch Unsinn=Elefant hineinschreiben - das würde auch gespeichert und in deinen Bearbeitungen sichtbar sein. Einen Fehler bei den Keys bzw. Values kannst du somit nicht in dem Sinne machen.</p>
...
<div id="comment-20002-info" class="comment-info">
...
<div class="comment-text">
<p><span></span><span>@anzed</span>: Genau, nun erscheint der Änderungssatz auch in <a href="https://www.openstreetmap.org/user/anzed/edits">https://www.openstreetmap.org/user/anzed/edits</a> , super! Wenn deine Frage nun beantwortet ist, dann akzeptiere bitte meine Antwort und markiere die Frage somit als beantwortet.</p>
