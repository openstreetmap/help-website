...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-29961-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi i"ve tried the sniffing on facebook and getting the cookie the thing is i dont get any packets that contain it i use the filter http.cookie and i see nothing maybe its not working anymore since facebook is on https no matter what settings you use? everything else is captured ok i see all the packets just not the cookie any idea?</p></div><div id="question-tags" class="tags-container tags">facebook</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>18 Feb '14, 01:50</strong></p><img src="https://secure.gravatar.com/avatar/8763b54b3b4f03a15a26c4440a7d405a?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Dot&#39;s gravatar image" /><p>Dot<br />
