...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-22415-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm using debian sid and I installed gns3 and wireshark. I have a router connected to 2 Virtual PCs (using Virtual PC Simulator) and I want to capture the packets, but when I start capturing with wireshark I get the following error "End of file on pipe magic during open".</p></div><div id="question-tags" class="tags-container tags">capture gns3 debian linux</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>27 Jun '13, 08:51</strong></p><img src="https://secure.gravatar.com/avatar/52095964bc7d27aa8ff4d590f24475ef?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Magnus&#39;s gravatar image" /><p>Magnus<br />
