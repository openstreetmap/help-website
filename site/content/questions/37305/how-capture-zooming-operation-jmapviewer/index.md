...
<p>Then: via <a href="https://wiki.openstreetmap.org/wiki/Party_render">Party-Renderer</a> I came across <a href="http://zdila.github.io/gpx-animator/">GPX-animator</a> ... but no panning / zooming features there?</p>
<p>Some guys in the <a href="http://forum.openstreetmap.org/viewforum.php?id=42">OSM 3D forum</a> (see also <a href="https://wiki.openstreetmap.org/wiki/3D_Development">3D Development</a>) are doing things with <a href="https://wiki.openstreetmap.org/wiki/Blender">Blender</a> ... maybe we can feed blender with a simple OSM based map and capture any zooming/panning? Just seen: there is an OSM import plugin!!</p>
