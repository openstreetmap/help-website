...
<p>A possible python API is <a href="https://wiki.openstreetmap.org/wiki/Osmapi">https://wiki.openstreetmap.org/wiki/Osmapi</a></p>
...
<td><div class="item-right">
<div class="answer-body">
<p>According to the OSM wiki about <a href="https://wiki.openstreetmap.org/wiki/Overpass_API">Overpass_API</a> there is a python wrapper for queries:</p>
