...
<p>I read <a href="https://help.openstreetmap.org/questions/42891/damaged-bridge-and-footpath-closed-until-repaired">this</a> and <a href="https://help.openstreetmap.org/questions/50247/bridge-under-repair">this</a> question. I tried the suggestions (changed <code>highway=pedestrian</code> to <code>construction=pedestrian</code> + <code>highway=construction</code> + <code>access=no</code>) and still when I go to openstreetmap.org both of the routing options <a href="http://www.openstreetmap.org/directions?engine=mapzen_foot&amp;route=58.38071%2C26.72510%3B58.38101%2C26.72648#map=19/58.38081/26.72611">show</a> the <a href="http://www.openstreetmap.org/way/29420432">bridge</a> as passable (on foot). How to make it so that people wouldn't get directed to cross an unusable bridge?</p>
</div>
