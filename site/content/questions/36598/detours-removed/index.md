...
<p>1) If the changes had been recent, and the whole changeset is rubbish, then a complete changeset revert using <a href="https://wiki.openstreetmap.org/wiki/JOSM/Plugins/Reverter">JOSM's reverter plugin</a> would have been an option. As Simon says, normally 6-7 months is way too late for that - other people will have edited many of the ways since. In Qatar that may or may not be a problem - I'm not sure how much regular local mapping is going on.</p>
<p>2) Another JOSM option is the "<a href="https://wiki.openstreetmap.org/wiki/JOSM/Plugins/Undelete">undelete</a>" plugin. That requires that you find the numbers of the ways that have been deleted (and from looking at <a href="https://www.openstreetmap.org/changeset/20171525">this changeset</a> I'd guess that <a href="https://www.openstreetmap.org/way/256138077/history">this way</a> is one of them).</p>
<p>3) If you're not a regular JOSM user, then Potlatch 1's "undelete" option might be the easiest to use (I'll assume that <a href="https://www.openstreetmap.org/way/256138077/history">this way</a> is indeed the one to restore):</p>
<p>From the <a href="https://www.openstreetmap.org/way/256138077/history">history page for the way</a>, open a <a href="https://www.openstreetmap.org/node/2618315878">deleted node page</a> in another browser tab and select "view history".</p>
...
<p><a href="https://www.openstreetmap.org/edit?editor=potlatch2#map=18/25.36404/51.44839">https://www.openstreetmap.org/edit?editor=potlatch2#map=18/25.36404/51.44839</a></p>
<p>you get</p>
<p><a href="https://www.openstreetmap.org/edit?editor=potlatch#map=18/25.36404/51.44839">https://www.openstreetmap.org/edit?editor=potlatch#map=18/25.36404/51.44839</a></p>
...
<p>4) One other option (mentioned only for completeness) is the perl <a href="https://wiki.openstreetmap.org/wiki/Revert_scripts">revert scripts</a> - but I wouldn't suggest trying that unless you've done it before.</p>
<p>Whatever method you end up using, it might be a good idea to ask in the #osm <a href="https://wiki.openstreetmap.org/wiki/Irc">IRC</a> channel (either for someone to help with the undelete, or to double-check what you've done)</p>
</div>
