...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-8984-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>In Wireshark 1.6.0, ip.dsfield.dscp was displayed once applied as a column either in hexa or in text "Expedited Forwarding" e.g. In Wireshark 1.6.5, the same field only offers decimal or hexadecimal, based on the "show resolved" checked/unchecked. Is there an option to change decimal to text-based?</p><p>Thanks!</p></div><div id="question-tags" class="tags-container tags">ip.dsfield.dscp dscp</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>13 Feb '12, 14:47</strong></p><img src="https://secure.gravatar.com/avatar/e177d49ca6cc8f53ee58cb3de1c4fbaf?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="yul_analyzer&#39;s gravatar image" /><p>yul_analyzer<br />
