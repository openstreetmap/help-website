...
With 64 bit machines I could see more and more use for 64 bit value_strings in the future. Is there talk of supporting this in the future?</p></div><div id="comment-932-info" class="comment-info"><span class="comment-age">(12 Nov '10, 10:49)</span> tlann</div></div><span id="1042"></span><div id="comment-1042" class="comment"><div id="post-1042-score" class="comment-score"></div><div class="comment-text"><p>Preparing a parch with a new values_string_ext_64 and the needed supporting routines(match_.. etc) and submiting it at https://bugs.wireshark.org/bugzilla would be a good start.</p></div><div id="comment-1042-info" class="comment-info"><span class="comment-age">(20 Nov '10, 10:06)</span> Anders ♦</div></div></div><div id="comment-tools-905" class="comment-tools"></div><div class="clear"></div><div id="comment-905-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
