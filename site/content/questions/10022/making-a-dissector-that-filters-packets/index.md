...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-10022-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi! What I wonder is, how can you make so that your dissector compares the next packet to the previous one? I want to make so that if the next packet has the same data as the previous one, it wont be displayed. I dont want to show a large amount of packtes in a row that are identical, I only want to show packets where some change has been made to the data.</p><p>Anyone knows?</p><p>Cheers / Martino</p></div><div id="question-tags" class="tags-container tags">filter compare dissector packet wireshark</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>09 Apr '12, 01:09</strong></p><img src="https://secure.gravatar.com/avatar/90140f74d53512910ba33db4ef7d30de?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Martino&#39;s gravatar image" /><p>Martino<br />
