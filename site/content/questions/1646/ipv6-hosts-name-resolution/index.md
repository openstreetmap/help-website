...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-1646-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Greetings everyone,</p><p>I'm trying to get ipv6 name resolution working using hosts file. It works ok for IPv4 addresses but I've tried many formats for and still can't get it to translate IPv6 hosts, see below my attempts:</p><pre><code>fe80::10:18ff:fe99:9904 Machine1
