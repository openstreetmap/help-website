...
<p>Hi, I was verifying the Josm validation of an area and I get the error "Multipolygon relation should be tagged with area tags and not the outer way" with the <a href="https://www.openstreetmap.org/relation/2678858">relation 2678858</a>. Tried adding area tags like <code>natural=water</code> to the relation but it still gives me the error.</p>
</div>
