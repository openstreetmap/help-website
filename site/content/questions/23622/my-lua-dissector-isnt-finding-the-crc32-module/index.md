...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-23622-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, I have a .lua file. Can I get please instructions how to add it the wireshark and decode my message correctly (I have wireshark with version 1.8.6)?</p><p>I added it to my personal plugins folder and this is the message code every time I launch the program.</p><pre><code>Lua: Error during loading:
