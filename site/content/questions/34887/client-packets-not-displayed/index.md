...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-34887-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I've turned off all capture and display filters but still only get the server side of a client-server session. This even happens with simple pings. I can see the server responding but the ping request is missing. I can also see the client IP address but only for overhead type packets.</p></div><div id="question-tags" class="tags-container tags">filter ping</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>24 Jul '14, 09:50</strong></p><img src="https://secure.gravatar.com/avatar/97759e5fd4a2956092f8a884eba6658d?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="nutman&#39;s gravatar image" /><p>nutman<br />
