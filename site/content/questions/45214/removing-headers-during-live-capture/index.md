...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-45214-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Is there a method in which I can remove or filter headers keeping only the payload during a live capture via wireshark or tshark? I know that I can modify an existing capture using editcap.</p></div><div id="question-tags" class="tags-container tags">filter header remove headers</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>18 Aug '15, 13:07</strong></p><img src="https://secure.gravatar.com/avatar/7fa32aa16ce4137617bcee250f37805a?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="NiCe85&#39;s gravatar image" /><p>NiCe85<br />
