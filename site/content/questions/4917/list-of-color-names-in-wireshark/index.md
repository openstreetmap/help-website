...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-4918-score" class="post-score" title="current number of votes">3</div></div></td><td><div class="item-right"><div class="answer-body"><p>Try <strong><code>yellow3</code></strong> or <strong><code>yellow4</code></strong>. There are 4 shades of yellow (4 being the darkest).</p><p>On OSX, the GTK color picker (that Wireshark uses) recognizes the color names from <code>/usr/X11/share/X11/rgb.txt</code>:</p><pre><code>255 250 250     snow
