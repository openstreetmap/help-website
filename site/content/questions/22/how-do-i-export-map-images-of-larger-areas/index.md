...
<ul>
<li><strong><a href="http://www.openstreetmap.org/export">Export tab</a></strong>: This is probably the easiest solution but only works for small areas. Select one of the options that is suitable: Raw OpenStreetMap XML Data, Mapnik Image, Osmarender Image, Embeddable HTML</li>
...
<li><strong><a href="http://wiki.openstreetmap.org/wiki/Bigmap">bigmap.cgi</a></strong>: This lets you select an area and download a small perl script that, when run, outputs the requested area in one big .png file. It stitches the grphic together from the single 256x256 pixel tile images.</li>
...
<ul>
<li><strong>osmarender</strong>: <a href="http://wiki.openstreetmap.org/wiki/Osmarender">http://wiki.openstreetmap.org/wiki/Osmarender</a></li>
<li><strong>or/p</strong>: is an osmarender drop-in replacement that is faster (written in perl). See <a href="http://wiki.openstreetmap.org/wiki/Orp">http://wiki.openstreetmap.org/wiki/Orp</a></li>
<li><strong>mapnik</strong>: Full blown mapnik install is probably NOT what you want to do when all you need is some nice maps. But hey, <a href="http://wiki.openstreetmap.org/wiki/Mapnik">here is information about the mapnik renderer</a>.</li>
</ul>
<p>If you decide you want to customize or render things on your own, also have a look at the related question "<a href="http://help.openstreetmap.org/questions/136/how-do-i-render-my-own-maps-for-my-website">How do I render Maps for my own website</a>".</p>
</div>
...
<p>See <a href="http://wiki.openstreetmap.org/wiki/Static_map_images">http://wiki.openstreetmap.org/wiki/Static_map_images</a></p>
</div>
<div class="answer-controls post-controls">
&#10;</div>
<div class="post-update-info-container">
