...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-13084-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>In IO Graph I would like to use tick interval value other than 0.001/0/0.01/0.1/1/10 second like 0.025 second. Is there an add-on somewhere that allows us to specify our own value or do I need to perhaps request that?</p></div><div id="question-tags" class="tags-container tags">graph tick io interval</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>27 Jul '12, 17:02</strong></p><img src="https://secure.gravatar.com/avatar/327a1e6f77d9d54ab928d1b6327da4b8?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="ntwkeng&#39;s gravatar image" /><p>ntwkeng<br />
