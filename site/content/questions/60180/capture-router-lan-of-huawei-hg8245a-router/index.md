...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-60180-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have Home WLAN Router it is Huawei HG8245A for parental monitoring purpose i want to tap the router connection and monitor the inbound and outbound router connection is it possible to do that without netgate, Mikrotik RB, etc ?</p></div><div id="question-tags" class="tags-container tags">router lan huawei capture</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>19 Mar '17, 10:09</strong></p><img src="https://secure.gravatar.com/avatar/160575a5c1f58ed2a414f48245e32ee8?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="dklainbz&#39;s gravatar image" /><p>dklainbz<br />
