...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-30702-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hello,</p><p>Fairly new to Wireshark. When I ran this capture on an ip address it has this Ethernet FCS Incorrect event for every ping. I'm not sure if this is something I need to worry about or not.</p><p>I was capturing a Class B network checking for FCS incorrect events and it was alarming.</p><p>I don't see a way to add the capture here?</p></div><div id="question-tags" class="tags-container tags">fcs</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>11 Mar '14, 18:53</strong></p><img src="https://secure.gravatar.com/avatar/8b3a5f496dccbdfba2e2873875976f5f?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="sharkme&#39;s gravatar image" /><p>sharkme<br />
