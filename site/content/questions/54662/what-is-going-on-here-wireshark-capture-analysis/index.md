...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-54662-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Just started Wireshark and loving it so far, slowly working my way through the documentation and getting the hang of it, however, I was wondering if a guru could give me a bit of advice to what is going on in these two instances.</p><p>Firstly, 192.168.1.3 is appearing a lot, what is it? I don't believe I have a .3 full stop, somebodies Laptop or something maybe?</p><pre><code>192.168.1.254   192.168.1.255   NBNS    92  Name query NB HOME&lt;1d&gt;
...
192.168.1.71    192.168.1.255   BROWSER 250 Domain/Workgroup Announcement UOD, NT Workstation, Domain Enum</code></pre></div><div id="comment-54666-info" class="comment-info"><span class="comment-age">(08 Aug '16, 08:23)</span> grahamb ♦</div></div></div><div id="comment-tools-54664" class="comment-tools"></div><div class="clear"></div><div id="comment-54664-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
