...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-47046-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, wireshark (V1.12.4) is showing 2 consecutive bytes named "SubIdx" in a SDO info response (OpCode = 0x6). But I think the second one should be the "ValueInfo" instead. Can you confirm that? Any workaround for this to show it in the right way?</p></div><div id="question-tags" class="tags-container tags">maibox sdo ethercat</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>29 Oct '15, 00:56</strong></p><img src="https://secure.gravatar.com/avatar/dcd46f3743b55a8df576f41d4c27b1b4?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="ThoKu&#39;s gravatar image" /><p>ThoKu<br />
