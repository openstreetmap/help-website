...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-26176-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>Last night I downloaded the latest Wireshark dmg for OSX and installed it. After launching wireshark, I found that all text in the GUI are not shown, the menu bars, menu items, dialogs, everything. Only icons are shown in the UI. I deleted all directions like .config, .gtk<em>, .wireshark</em>, rerun fc-cache, and the problem still persist. Can anyone give me some hint on what might go wrong here? Thanks!</p><p>Jimmy</p></div><div id="question-tags" class="tags-container tags">text gui</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>18 Oct '13, 09:44</strong></p><img src="https://secure.gravatar.com/avatar/5d6c08ff6fb17a635ecd0d2a59e08b24?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="jmzhou13&#39;s gravatar image" /><p>jmzhou13<br />
