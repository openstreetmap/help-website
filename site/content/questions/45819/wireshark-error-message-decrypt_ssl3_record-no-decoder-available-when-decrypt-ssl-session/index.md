...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-45819-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have a <a href="https://www.cloudshark.org/captures/efbcd03eab1a">pcap</a> of a HTTPS session. When trying to decrypt it, it complained about "decrypt_ssl3_record: no decoder available". I have made sure I am not using DHE based cipher, but still getting the above message.<br />
