...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-36365-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>As Paul indicated, the next thing to occur would be some data packets from the client.<br />
...
</p><p>When I do dcdiags and repadmin /binds. I get RPC errors, so I think it could be related to that as well. However, all the services seem to be running correctly.</p></div><div id="comment-36374-info" class="comment-info"><span class="comment-age">(16 Sep '14, 11:50)</span> TheCarefulOne</div></div></div><div id="comment-tools-36365" class="comment-tools"></div><div class="clear"></div><div id="comment-36365-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
