...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-25481-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I am using WS on a Diameter trace. I am looking for records that do not have a matching end-to-end value. In the trace file the Diameter packets are identified with a [Request in: xxx] tag or the tag [Answer In: yyy] where xxx and yyy are record numbers. My objective is to find all orphaned Diameter records, meaning the records that do not have a matching end-to-end value or do not have matching Tags (mated Request – Answer). I am looking for Request messages that do not have an response.</p></div><div id="question-tags" class="tags-container tags">diameterend2end</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>01 Oct '13, 11:02</strong></p><img src="https://secure.gravatar.com/avatar/bb7eccec0a05bdb4bc4c8c5eda35231b?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="plaurie&#39;s gravatar image" /><p>plaurie<br />
