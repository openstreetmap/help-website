...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-38857-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have installed Tcpdump on my RPI and placed the RPI between my router and server, i want to capture ip add. there is connecting and what files they are getting access to and ofc with a timestamp-</p><p>But i can figure out what flags i have to use ? right know i am running</p><p>tcpdump -I br0</p><p>and i really need it to be readable by a human :D</p></div><div id="question-tags" class="tags-container tags">flags tcpdump</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>02 Jan '15, 16:31</strong></p><img src="https://secure.gravatar.com/avatar/eec29ee392df056f48c8b65be9a86716?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="notaduck&#39;s gravatar image" /><p>notaduck<br />
