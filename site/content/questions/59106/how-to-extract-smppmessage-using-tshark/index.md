...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-59106-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I am trying to extract SMPP message content using tshark.</p><p>But when I use -T fields -e "smpp.message" it only prints 1 and not the actual message.</p><pre><code>C:\Program Files\Wireshark&gt;tshark -r SMPP.pcap -2 -R &quot;(smpp.command_id == 0x00000004)&quot; -T fields -e         smpp.message -E header=y
smpp.message
1
1
1
