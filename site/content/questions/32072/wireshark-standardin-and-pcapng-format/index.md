...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-32072-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm trying to send a pcapng format file to wireshark standard in or a named pipe, but I continue to get an error "unrecognized libcap format. Is there still a problem reading this type file through this interface?</p><p>My command looks like this:</p><p>cat capture_NG.pcap | wireshark -k -i -</p><p>I've also tried:</p><p>wireshark -k -i &lt;(cat capture_NG.pcap)</p></div><div id="question-tags" class="tags-container tags">pipe input pcapng standard</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>22 Apr '14, 16:54</strong></p><img src="https://secure.gravatar.com/avatar/1607659be497d8c263c7061a0dd9159b?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="siber&#39;s gravatar image" /><p>siber<br />
