...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-13940-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>Why do you want to rename the files? If the CSV files were generated with tshark (or wireshark), simply repeat the "export" operation and this time use the correct filename ;-))</p><p>Regards<br />
