...
<p>The problem with "highway=escape" is that gravel traps tend not really to be like "highways" - they're normally a patch of gravel (or these days sometimes tarmac) separated from the circuit by grass (like this one that you mapped at Assen <a href="http://www.openstreetmap.org/way/359189162">here</a>). A "highway=escape" running down a hill is a continuation of the highway and is a linear feature - a gravel trap isn't really either of those.</p>
...
<p>A quick look at <a href="http://www.openstreetmap.org/#map=15/52.3903/4.5399">Zandvoort</a>, <a href="http://www.openstreetmap.org/#map=15/52.0732/-1.0189">Silverstone</a>, <a href="http://www.openstreetmap.org/#map=15/52.5163/-0.6567">Rockingham</a>, <a href="http://www.openstreetmap.org/#map=16/53.1732/-2.6148">Oulton</a>, <a href="http://www.openstreetmap.org/#map=15/53.3088/-0.0661">Cadwell</a> and <a href="http://www.openstreetmap.org/#map=16/52.8304/-1.3767">Donington</a> doesn't reveal any other mapped gravel traps. At <a href="http://www.openstreetmap.org/query?lat=36.58455&amp;lon=-121.74914#map=19/36.58458/-121.74883">Laguna Seca</a> someone's mapped the ones around the Corkscrew as "natural=beach", which surely isn't correct!</p>
</div>
