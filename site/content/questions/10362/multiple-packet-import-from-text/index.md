...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-10362-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi, i have a TCP stream with multiple request/response in a text file. When importing the text file, it seems that all the file is put into one packet. how do i distinguish between the different HTTP request/response while importing?</p></div><div id="question-tags" class="tags-container tags">import multiple packets</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>20 Apr '12, 16:04</strong></p><img src="https://secure.gravatar.com/avatar/ffeb42cf810a0d7e76cce4b9f7e77d6c?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="yuvalshu&#39;s gravatar image" /><p>yuvalshu<br />
