...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-57403-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>This looks like some incomplete work in the dissector or maybe a different implementation of the LLTP protocol. In the source code of the dissector I find:</p><pre><code>case 0x11: /* Friendly Name */
    if (length != 0)
