...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-37018-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><p>You should set a capture filter:</p><pre><code>port 80 and host mydomain.com</code></pre>So Wireshark does not capture other packets. The display filter is like the name says only for hiding packets, so if you remove the filter other packets will show up.<br />
