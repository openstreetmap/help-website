...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-12017-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>I ready tryed with tcp.flags.reset==1 or tcp.flags.fin==1 but this is not usefull to me,</p></blockquote><p>why is that not usefull for you?</p><p>Did you try to combine those filters with the port number?</p><blockquote><p><code>tcp.port == 1234 and (tcp.flags.reset==1 or tcp.flags.fin==1)</code><br />
