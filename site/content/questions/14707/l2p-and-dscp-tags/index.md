...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-14707-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>How to check L2P and DSCP tags in the packet. Which NIC supports the tagged packets? If driver is stripping off the tags then how to check the same?</p></div><div id="question-tags" class="tags-container tags">1.0.4 version</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>04 Oct '12, 05:57</strong></p><img src="https://secure.gravatar.com/avatar/f57bc43f11cf21dbbe03d7f15d083de6?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Maldini&#39;s gravatar image" /><p>Maldini<br />
