...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-29601-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>when i check for the latest version of wireshark in my redhad linux(Red Hat Enterprise Linux Server release 6.2 (Santiago)) system it showed me this yum list wireshark*</p><p>wireshark.x86_64 1.2.15-2.el6_2.1 @rhel-x86_64-server-6.4.z wireshark.i686 1.2.15-2.el6_2.1 rhel-x86_64-server-6.4.z<br />
