...
<p>I have an OSM tile server that I built using switch2osm "Building a tile server from packages". It works fine. Now I want to make some styling changes. I have set up openstreetmap-carto as per the instructions. When I create the xml file I get the same error as described in a <a href="/questions/14468/format-of-osmxml-stylesheet">previous post</a></p>
