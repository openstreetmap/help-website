...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-22562-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I just want to report recurrent problems with access to <a href="http://ask.wireshark.org">http://ask.wireshark.org</a> during the last two weeks. I often see error messages from Cloudflare like "no live server available, please try later" or something like this:</p><pre><code>502 Bad Gateway
