...
<p>Anyway, back on topic, I don't consider using separate nodes for the pharmacies to be an error. I'd recommend just leaving them alone, since there's a general ethic to respect previous mappers' work unless it's erroneous or deprecated (see <a href="/questions/69363/rule-about-discouraging-remapping">https://help.openstreetmap.org/questions/69363/rule-about-discouraging-remapping</a> for a discussion of that topic.)</p>
</div>
