...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-36891-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>help me! has windows server 2008 r2 which is connected to the cisco. when copying from the server to the workstation is slowly up. wireshark on the server says about such a problem:[Reassembly error, protocol TCP: New fragment overlaps old data (retransmission?)]</p></div><div id="question-tags" class="tags-container tags">windows2008</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>07 Oct '14, 02:32</strong></p><img src="https://secure.gravatar.com/avatar/024ee53df187a9dc1bf8ee5556a02098?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="AEI&#39;s gravatar image" /><p>AEI<br />
