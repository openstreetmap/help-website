...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-63052-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have a initiator with the VLAN ID of 1002, and both the switch and target are on the same VLAN. In order to capture this session with Wireshark, do I need to enable a specific capture filter? Or should I just be able to see it regardless and I'm doing something entirely wrong. Thanks</p></div><div id="question-tags" class="tags-container tags">iscsi vlan</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>24 Jul '17, 09:49</strong></p><img src="https://secure.gravatar.com/avatar/7d9a9f0dcd958a44ea22b08a097a443f?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="cartersnay&#39;s gravatar image" /><p>cartersnay<br />
