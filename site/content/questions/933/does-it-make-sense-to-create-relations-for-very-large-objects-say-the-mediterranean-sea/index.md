...
They are also very large objects where the outlines are not well defined (valleys, massif). You can find some proposals on the wiki about such things like <a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Valley"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Valley"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Valley">http://wiki.openstreetmap.org/wiki/Proposed_features/Valley</a>, <a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Massif"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Massif"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Massif">http://wiki.openstreetmap.org/wiki/Proposed_features/Massif</a> or <a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Sea"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Sea"></a><a href="http://wiki.openstreetmap.org/wiki/Proposed_features/Sea">http://wiki.openstreetmap.org/wiki/Proposed_features/Sea</a> using nodes (so it's more placing a label) or even this relation proposal : <a href="http://wiki.openstreetmap.org/wiki/Relations/Proposed/Region"></a><a href="http://wiki.openstreetmap.org/wiki/Relations/Proposed/Region"></a><a href="http://wiki.openstreetmap.org/wiki/Relations/Proposed/Region">http://wiki.openstreetmap.org/wiki/Relations/Proposed/Region</a> but I don't know it's widely used today.</p>
</div>
