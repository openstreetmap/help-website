...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-25059-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>How would I go about diagnosing it myself?</p></blockquote><p>Log into the router via ssh and run <a href="http://emtunc.org/blog/04/2011/installing-tcpdump-on-dd-wrt-wrt54gl/">tcpdump on dd-wrt</a></p><blockquote><p>tcpdump -ni eth0 not port 22</p></blockquote><p>Maybe eth0 is not the right interface. Please check with <strong>ifconfig</strong>.</p><p>Regards<br />
