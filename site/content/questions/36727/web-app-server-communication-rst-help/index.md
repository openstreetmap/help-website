...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-36727-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>All,</p><p>We have admins reporting a network issue; however have confirmed there to be no network issue occuring. The issue is intermittent and the capture below is whats captured during the issue. Can anyone assist me in determining the cause for the [RST] at the very end of this stream?</p><p>Thanks in advance for any and all feedback</p><pre><code>No.     Source Destination Protocol Length 
