...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-5403-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I have a .pcap file after capturing voice packets. I now want to filter RTP packets (with header). When I select stream I am interested in and do "follow UDP stream" I get the udp payload (RTP including the header). But for all the packets captured there is no packet size. My application would want a 4 byte "packet length" before each packet. How can I get this fro wireshark.</p><p>Thanks for the help in advance.</p></div><div id="question-tags" class="tags-container tags">length udp payload rtp</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>02 Aug '11, 09:23</strong></p><img src="https://secure.gravatar.com/avatar/a93f17d087fcc6182314daa5e7218994?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="shailesh&#39;s gravatar image" /><p>shailesh<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-5418-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>There is no way to do that with "Follow UDP Stream" unless you change the source code and recompile Wireshark.</p><p>It might be easier to write a little script/program that uses the libpcap library to extract the UDP payload and save it with a length header in front of it. Then you can feed the individual RTP streams to it...</p></div><div class="answer-controls post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>answered <strong>03 Aug '11, 01:25</strong></p><img src="https://secure.gravatar.com/avatar/7901a94d8fdd1f9f47cda9a32fcfa177?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="SYN-bit&#39;s gravatar image" /><p>SYN-bit ♦♦<br />
