...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-3795-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>ISO 8073 is actually <strong><a href="http://wiki.wireshark.org/COTP">COTP</a></strong> (Connection Oriented Transport Protocol), not "COPT". here is an example of using <a href="http://wiki.wireshark.org/Lua/Dissectors">dissector chaining</a> to get to the COTP data:</p><pre><code>do
