...
<p>Currently, we have about <a href="http://taginfo.openstreetmap.org/keys/amenity">4.6 millions objects tagged as 'amenity'</a>, <a href="http://taginfo.openstreetmap.org/keys/leisure">1.2m as 'leisure'</a> and <a href="http://taginfo.openstreetmap.org/keys/tourism">0.5m as 'tourism</a>'. Fur such amount of data, you cannot use one of the servers delivering extracts (<a href="http://wiki.openstreetmap.org/wiki/Xapi">like XAPI or compatibles</a>). For you, I would recommend to download a <a href="http://wiki.openstreetmap.org/wiki/Planet.osm">full planet dump</a> and use one tool extracting the data from the file like <a href="http://wiki.openstreetmap.org/wiki/Osmosis">Osmosis</a>, <a href="http://wiki.openstreetmap.org/wiki/Osmium">Osmium</a> or <a href="http://wiki.openstreetmap.org/wiki/Osmium">OSMFilter</a>. Probably the easiest to use is Osmosis (but maybe not the fastest).</p>
</div>
