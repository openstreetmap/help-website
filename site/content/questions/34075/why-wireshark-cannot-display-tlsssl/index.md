...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-34078-score" class="post-score" title="current number of votes">2</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>But why it doesn't show as "TLS/SSL"?</p></blockquote><p>Because it's not on the standard port for SSL/TLS. You can add your port (12120):</p><blockquote><p>Edit -&gt; Preferences -&gt; Protocols -&gt; HTTP -&gt; SSL/TLS Ports</p></blockquote><p>Change it to: 443,12120</p><p>Regards<br />
