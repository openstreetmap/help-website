...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-29146-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>During the course of a prolonged mail server performance issue we determined that we needed to make sure the mail server was sending smaller packets to get the best performance. We manually reduced the MSS setting on the server to 1380 but I am seeing in the 3 way handshake that the server is advertising MSS = 1340.</p><p>Thanks, Steve</p></div><div id="question-tags" class="tags-container tags">mss</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>24 Jan '14, 15:10</strong></p><img src="https://secure.gravatar.com/avatar/9f6a6dca6af7b0f8a0161945a70eb891?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="skrall1965&#39;s gravatar image" /><p>skrall1965<br />
