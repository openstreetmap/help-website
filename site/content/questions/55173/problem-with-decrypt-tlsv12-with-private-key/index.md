...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-55173-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count">1</div></div></td><td><div id="item-right"><div class="question-body"><p>Traffic is successfully decrypted on computer where traces were collected, but I can't decrypt the same traces on another computer. I use the same pem key on both computers.</p><pre><code>dissect_ssl enter frame #340 (first time)
