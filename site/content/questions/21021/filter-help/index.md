...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-21021-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hello,</p><p>I'm a novice user. I suspect my computer's been hacked. With help, I've captured a trace of my router traffic, and want to filter the results in Wireshark.</p><p>What should I enter in the filter field? I'm trying to achieve two things:</p><ol><li>filter out 'noise' (anything that would definitely NOT be related to suspicious activity)</li><li>filter out traffic on my 'guest' account so I only see traffic on 'my wifi' account.</li></ol><p>Thanks!</p></div><div id="question-tags" class="tags-container tags">beginner filters</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>08 May '13, 04:30</strong></p><img src="https://secure.gravatar.com/avatar/c838057bd28cfa50e894a06b9136771d?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="melanie&#39;s gravatar image" /><p>melanie<br />
