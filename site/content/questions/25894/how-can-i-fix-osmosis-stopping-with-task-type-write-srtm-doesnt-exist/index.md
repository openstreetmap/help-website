...
description = '''Hi, I am using your osmosis-srtm-plugin for my project, but I have encounter some problem, I download the Osmosis from https://wiki.openstreetmap.org/wiki/Osmosis, and put osmosis-srtm-plugin in lib/default, and run the command  osmosis.bat --read-xml map.osm --write-srtm srvBase=http://dds.cr.usgs.g...'''
