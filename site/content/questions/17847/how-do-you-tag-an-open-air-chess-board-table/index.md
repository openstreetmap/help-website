...
<p>First, go to the <a href="http://wiki.openstreetmap.org/wiki/Main_Page">wiki documentation</a> and use the "search" field with "chess". This will show you a <a href="http://wiki.openstreetmap.org/w/index.php?title=Special%3ASearch&amp;search=chess">list of wiki pages containing the word 'chess'</a>. Usually, only the top 2 or 3 on the list are relevant. Here, the first result is the good one : <a href="http://wiki.openstreetmap.org/wiki/Tag:sport%3Dchess">Tag:sport=chess</a>.</p>
