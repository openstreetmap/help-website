...
<p>Firstly you don't state the source of your data. It is important that external data loaded into OSM is both compatible with the OdBL licence (sorry for tautology) <strong>and</strong> that the import itself is carried out according to the <a href="http://wiki.openstreetmap.org/wiki/Import/Guidelines">established guidelines</a>.</p>
