...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-31998-score" class="post-score" title="current number of votes">0</div></div></td><td><div class="item-right"><div class="answer-body"><blockquote><p>What should I do to get the cameras to work/to get recognized?</p></blockquote><p>maybe call the vendors support?</p><p>Honestly, if the cameras are not detected by your surveillance software and you cannot see anything of them (ARP, boradcasts, etc.) in a Wireshark capture, how are we supposed to help !?!</p><p>Regards<br />
