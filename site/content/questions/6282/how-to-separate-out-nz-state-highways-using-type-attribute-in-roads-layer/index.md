...
<p>After posting this I realised I had forgotten to mention that I am working off downloaded NZ road shapefile from <a href="http://download.geofabrik.de/osm/australia-oceania/">http://download.geofabrik.de/osm/australia-oceania/</a> - so perhaps this download does not include all road attributes. I also noted a New Zealand discussion on highway attribution - <a href="http://wiki.openstreetmap.org/wiki/Talk:WikiProject_New_Zealand">http://wiki.openstreetmap.org/wiki/Talk:WikiProject_New_Zealand</a> so I will follow up with the New Zealand OSM group.</p>
