...
description = '''Tagging a pub as a single node or a building with amenity=pub seems well defined. See https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dpub Some pubs, however, have their own car park, a beer garden and other facilities on site. To map these I have created an area that is tagged as landuse=retail and...'''
...
<p>Tagging a pub as a single node or a building with amenity=pub seems well defined. See <a href="https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dpub">https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dpub</a></p>
