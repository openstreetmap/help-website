...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-6842-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I am trying to decode TCAP messages(for CAP protocol) using WIreshark(v1.0.9),and I find that the data contents are not decoded at all while trying to open the SS7 IP traces recived.</p><p>Does it required to have special Dictionary files for TCAP while decoding such messages.</p></div><div id="question-tags" class="tags-container tags">tcap</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>11 Oct '11, 01:55</strong></p><img src="https://secure.gravatar.com/avatar/5378f88f4cd501f4cdf3709d79aa0d4f?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="rouseparty&#39;s gravatar image" /><p>rouseparty<br />
...
<table style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-6846-score" class="post-score" title="current number of votes">1</div></div></td><td><div class="item-right"><div class="answer-body"><p>Hi, The version you are using is very old, 1.6.2 is out. You may have to set the preferences to get Camel(CAP) deissected check the SSN used for your packets and ensure that the same SSN(s) are set in the Camel preferences.</p></div><div class="answer-controls post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>answered <strong>11 Oct '11, 07:05</strong></p><img src="https://secure.gravatar.com/avatar/2d3d425a7a829209431fb38d326b53af?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="Anders&#39;s gravatar image" /><p>Anders ♦<br />
