...
<p>I notice though that the way is mapped as part of <a href="https://www.openstreetmap.org/relation/3250561">a local walking route</a> which the <a href="https://klompenpaden.nl/klompenpad/turfvelderpad/">operator says is marked with red clogs</a>, so you might want to use "permissive" rather than "private", assuming the operator had suitable permissions to signpost the route.</p>
</div>
