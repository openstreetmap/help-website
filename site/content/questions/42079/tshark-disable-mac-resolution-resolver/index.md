...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-42079-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I'm running Tshark to test for WiFi probes but sometimes I get instead of <code>40:0e:85:02:6a:a6</code> a <code>Apple_df:76:88</code>. Is there any way to get the REAL Mac instead of the resolved MAC? I already tried <code>column.format</code> with <code>"%uhs"</code> but this does not seem to work?</p><p>Is there any way to disable this MAC lookup/resolution in the output of tshark?</p></div><div id="question-tags" class="tags-container tags">tshark columns</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>05 May '15, 06:51</strong></p><img src="https://secure.gravatar.com/avatar/c990756255cdafe397a0266c4b1dcc93?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="sudohenk&#39;s gravatar image" /><p>sudohenk<br />
