...
ComputerModel=VMware </code></pre></div><div id="comment-22566-info" class="comment-info"><span class="comment-age">(02 Jul '13, 11:38)</span> Kurt Knochner ♦</div></div><span id="22569"></span><div id="comment-22569" class="comment"><div id="post-22569-score" class="comment-score"></div><div class="comment-text"><p>As @Kurt suspected, the compression is done at the (web)application layer, not at the HTTP layer. This means wireshark has no knowledge on how to interpret the data and is therefor not able to decompress it for you.</p></div><div id="comment-22569-info" class="comment-info"><span class="comment-age">(02 Jul '13, 13:04)</span> SYN-bit ♦♦</div></div></div><div id="comment-tools-22561" class="comment-tools"></div><div class="clear"></div><div id="comment-22561-form-container" class="comment-form-container"></div><div class="clear"></div></div></td></tr></tbody></table>
