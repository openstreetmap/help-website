...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-16442-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>I am using wireshark to capture synchrophasor data. However, the config2 frame is sent over a separate TCP port, and the data frame is sent over a separate UDP port.</p><p>Is it possible to associate the config2 frame with the data frame(s) in this situation?</p><p>I have seen it work when the two are sent over the same port.</p></div><div id="question-tags" class="tags-container tags">synchrophasor</div><div id="question-controls" class="post-controls"></div><div class="post-update-info-container"><div class="post-update-info post-update-info-user"><p>asked <strong>29 Nov '12, 14:04</strong></p><img src="https://secure.gravatar.com/avatar/ccb3d212d1e69518e87ab49f737bb55f?s=32&amp;d=identicon&amp;r=g" class="gravatar" width="32" height="32" alt="vgharpure&#39;s gravatar image" /><p>vgharpure<br />
