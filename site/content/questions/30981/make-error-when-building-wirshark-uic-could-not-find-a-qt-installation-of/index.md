...
<table id="question-table" style="width:100%;"><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><tbody><tr class="odd"><td style="width: 30px; vertical-align: top"><div class="vote-buttons"><div id="post-30981-score" class="post-score" title="current number of votes">0</div><div id="favorite-count" class="favorite-count"></div></div></td><td><div id="item-right"><div class="question-body"><p>Hi,</p><p>I am trying to build wireshark on ubuntu 12.04.</p><p>I ran ./autogen.sh and ./configure.</p><p>./configure complained about uninstalled packages and I ran the following commands to get it work</p><pre><code> pkg-config --libs --cflags Qt5Core
